...
autocomplete(document.getElementById("myInput"), arrayBusinesses);

function populateFileds(){
  console.log("in populatefields");
  for(let i = 0; i < 5; i++){
    if(document.getElementById("myInput") = arrayBusinesses[i]){
      ...
      document.getElementById("BusinessCountry").value = response.results[0].properties.countryCode;
      document.getElementById("BusinessZipCode").value = response.results[0].properties.postalCode;
      document.getElementById("BusinessStreetAddress").value = response.results[0].properties.street;
    }
...
function autocomplete(inp, arr) {
  ...
  function populateFields(inp, arr) {
